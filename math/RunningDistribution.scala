...
//  val v_k: Option[Double] = None,
//  val count: Int = 0) extends Distribution[Double] {
//
...
//    */
//  def + (nextValue: Double): RunningDistribution = {
...
//    }
//
//    new RunningDistribution(nextMin, nextMax, nextMean, nextV_k, nextCount)
//  }
//
//  /**
//    * adds a new observation to this Distribution
...
//    * @return a new Distribution
//    */
//  def + (rhs: Observation[Double]): RunningDistribution = {
//    if (this.count == 0) {
//      RunningDistribution(rhs.value)
//    } else {
//      rhs.mean match {
//        case None => this
//        case Some(nextValue) =>
...
//  def apply(): RunningDistribution = new RunningDistribution()
//  def apply(valueOne: Double): RunningDistribution = new RunningDistribution(Some(valueOne), Some(valueOne), Some(valueOne), Some(0), 1)
//}
