...
import cse.fitzgero.mcts.core.terminationcriterion.TerminationCriterion
...
trait MonteCarloTreeSearch[S,A] {
  ...
  protected val terminationCriterion: TerminationCriterion[S,A,Tree]
  ...
  /**
    ...
    */
  type Tree <: MonteCarloTree[S,A,Reward,Update,Coefficients,Tree]
